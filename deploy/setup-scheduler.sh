...
FUNCTION_URL="${1:?Usage: setup-scheduler.sh <function-url> [project-id] [region] [service-account] [timezone]}"
PROJECT_ID="${2:-$(gcloud config get-value project)}"
REGION="${3:-me-west1}"
SERVICE_ACCOUNT="${4:-fhenix-monitoring@appspot.gserviceaccount.com}"
TIMEZONE="${5:-Asia/Jerusalem}"
...
echo "Schedule: 09:30 daily ($TIMEZONE)"
